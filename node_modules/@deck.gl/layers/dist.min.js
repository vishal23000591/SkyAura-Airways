...
// #endif
`;var Uo=`// #if (defined(SHADER_TYPE_FRAGMENT) && defined(LIGHTING_FRAGMENT)) || (defined(SHADER_TYPE_VERTEX) && defined(LIGHTING_VERTEX))
struct AmbientLight {
  color: vec3<f32>,
};
...
`;var Wo=3,Sr=255,Lt;(function(o){o[o.POINT=0]="POINT",o[o.DIRECTIONAL=1]="DIRECTIONAL"})(Lt||(Lt={}));var Y={props:{},uniforms:{},name:"lighting",defines:{MAX_LIGHTS:Wo},uniformTypes:{enabled:"i32",lightType:"i32",directionalLightCount:"i32",pointLightCount:"i32",ambientLightColor:"vec3<f32>",lightColor0:"vec3<f32>",lightPosition0:"vec3<f32>",lightDirection0:"vec3<f32>",lightAttenuation0:"vec3<f32>",lightColor1:"vec3<f32>",lightPosition1:"vec3<f32>",lightDirection1:"vec3<f32>",lightAttenuation1:"vec3<f32>",lightColor2:"vec3<f32>",lightPosition2:"vec3<f32>",lightDirection2:"vec3<f32>",lightAttenuation2:"vec3<f32>"},defaultUniforms:{enabled:1,lightType:Lt.POINT,directionalLightCount:0,pointLightCount:0,ambientLightColor:[.1,.1,.1],lightColor0:[1,1,1],lightPosition0:[1,1,2],lightDirection0:[1,1,1],lightAttenuation0:[1,0,0],lightColor1:[1,1,1],lightPosition1:[1,1,2],lightDirection1:[1,1,1],lightAttenuation1:[1,0,0],lightColor2:[1,1,1],lightPosition2:[1,1,2],lightDirection2:[1,1,1],lightAttenuation2:[1,0,0]},source:Uo,vs:Fe,fs:Fe,getUniforms:wr};function wr(o,t={}){if(o=o&&{...o},!o)return{...Y.defaultUniforms};o.lights&&(o={...o,...br(o.lights),lights:void 0});let{ambientLight:e,pointLights:i,directionalLights:n}=o||{};if(!(e||i&&i.length>0||n&&n.length>0))return{...Y.defaultUniforms,enabled:0};let s={...Y.defaultUniforms,...t,...Mr({ambientLight:e,pointLights:i,directionalLights:n})};return o.enabled!==void 0&&(s.enabled=o.enabled?1:0),s}function Mr({ambientLight:o,pointLights:t=[],directionalLights:e=[]}){let i={};i.ambientLightColor=De(o);let n=0;for(let r of t){i.lightType=Lt.POINT;let s=n;i[`lightColor${s}`]=De(r),i[`lightPosition${s}`]=r.position,i[`lightAttenuation${s}`]=r.attenuation||[1,0,0],n++}for(let r of e){i.lightType=Lt.DIRECTIONAL;let s=n;i[`lightColor${s}`]=De(r),i[`lightDirection${s}`]=r.direction,n++}return n>Wo&&Go.log.warn("MAX_LIGHTS exceeded")(),i.directionalLightCount=e.length,i.pointLightCount=t.length,i}function br(o){let t={pointLights:[],directionalLights:[]};for(let e of o||[])switch(e.type){case"ambient":t.ambientLight=e;break;case"directional":t.directionalLights?.push(e);break;case"point":t.pointLights?.push(e);break;default:}return t}function De(o={}){let{color:t=[0,0,0],intensity:e=1}=o;return t.map(i=>i*e/Sr)}var re=`uniform phongMaterialUniforms {
...
`;var B={props:{},name:"gouraudMaterial",vs:se.replace("phongMaterial","gouraudMaterial"),fs:re.replace("phongMaterial","gouraudMaterial"),defines:{LIGHTING_VERTEX:1},dependencies:[Y],uniformTypes:{ambient:"f32",diffuse:"f32",shininess:"f32",specularColor:"vec3<f32>"},defaultUniforms:{ambient:.35,diffuse:.6,shininess:32,specularColor:[.15,.15,.15]},getUniforms(o){let t={...o};return t.specularColor&&(t.specularColor=t.specularColor.map(e=>e/255)),{...B.defaultUniforms,...t}}};var Bo=`struct phongMaterialUniforms {
  ambient: f32,
  diffuse: f32,
  shininess: f32,
...
`;var ae={name:"phongMaterial",dependencies:[Y],source:Bo,vs:re,fs:se,defines:{LIGHTING_FRAGMENT:1},uniformTypes:{ambient:"f32",diffuse:"f32",shininess:"f32",specularColor:"vec3<f32>"},defaultUniforms:{ambient:.35,diffuse:.6,shininess:32,specularColor:[.15,.15,.15]},getUniforms(o){let t={...o};return t.specularColor&&(t.specularColor=t.specularColor.map(e=>e/255)),{...ae.defaultUniforms,...t}}};var jo=`uniform pointCloudUniforms {
  float radiusPixels;
  highp int sizeUnits;
} pointCloud;
