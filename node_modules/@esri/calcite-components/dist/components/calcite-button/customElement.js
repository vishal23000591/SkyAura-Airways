...
import { isServer, html, nothing } from "lit";
...
import { D as hasVisibleContent } from "../../chunks/dom.js";
...
class Button extends LitElement {
  ...
  render() {
    ...
    return InteractiveContainer({ disabled: this.disabled, children: html$1`<${DynamicHtmlTag} .ariaBusy=${this.loading} .ariaExpanded=${this.el.ariaExpanded ? this.el.ariaExpanded : null} .ariaLabel=${!this.loading ? getLabelText(this) : this.messages.loading} aria-live=polite class=${safeClassMap({
